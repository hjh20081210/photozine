  ...
  if (mode === 'POSTCARD') {
    if (isDouble) {
      ...
      const frontWrap = hasPhoto
        ? `以参考照片的主元素转为插画：在画面右侧约65%区域将照片中最具视觉吸引力的主元素转化为克制的手绘水彩/墨线/水粉插画，画面被不规则水彩淡墨晕染边框包裹，颜料扩散斑驳水痕，半透明水彩质感，低饱和柔和色彩，柔和平涂，边缘留白；左侧约35%区域为文字信息栏，垂直靠左对齐，顶部数字配细分割横线，大写粗体标题，LOCATION/DATE 两行标签加空白填写横线，底部三个水彩晕染毛边圆角色卡色块`
